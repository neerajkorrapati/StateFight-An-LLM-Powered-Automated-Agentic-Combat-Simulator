...
This entire project has been completely self coded , to better understand the understanding and implementation of llm's, so bear with me if you do find any silly errors.
